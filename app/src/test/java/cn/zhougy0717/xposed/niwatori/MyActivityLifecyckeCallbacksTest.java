...
@PrepareForTest({XposedBridge.class, ReceiverManager.class, MyActivityLifecyckeCallbacks.class})
public class MyActivityLifecyckeCallbacksTest {
    ...
    public void it_should_clear_out_the_temp_pref() throws Exception {
        ...
        view.getContext().getSharedPreferences(FlyingHelper.TEMP_SCREEN_INFO_PREF_FILENAME, Context.MODE_PRIVATE)
                .edit().putInt("test", 0).apply();
        callbacks.onActivityPaused(activity);
        SharedPreferences prefs = view.getContext().getSharedPreferences(FlyingHelper.TEMP_SCREEN_INFO_PREF_FILENAME, Context.MODE_PRIVATE);
